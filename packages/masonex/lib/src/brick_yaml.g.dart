...
BrickYaml _$BrickYamlFromJson(Map json) => BrickYaml(
  ...
  inFileGenerations:
      (json['in_file_generations'] as Map?)?.map(
...
Map<String, dynamic> _$BrickYamlToJson(BrickYaml instance) => <String, dynamic>{
  ...
  'environment': const BrickEnvironmentConverter().toJson(instance.environment),
...
BrickEnvironment _$BrickEnvironmentFromJson(Map json) =>
    BrickEnvironment(masonex: json['masonex'] as String? ?? 'any');
