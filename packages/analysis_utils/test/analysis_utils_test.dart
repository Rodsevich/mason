...
// void main() {
//   ClassAnalysis annonExample = ClassAnalysis.fromType(annotationExample);
//   ClassAnalysis parent = ClassAnalysis.fromType(ParentClass);
//   ChildClass c = ChildClass("sorp");
//   c.number = 2;
//   ClassAnalysis child = ClassAnalysis.fromInstance(c);
//   group("Parameters:", () {
//     test("methods", () {
...
//       expect(child.constructors[""].parameters.all.first.isThisInitializer,
//           isTrue);
